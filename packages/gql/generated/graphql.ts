...
export type GetCreatorsByAdminQuery = { __typename?: 'Query', getCreatorsByAdmin: { __typename?: 'GetAllCreatorsOutput', count: number, creators: Array<{ __typename?: 'ExtendedUsersEntity', avatarUrl?: string | null, bannerUrl?: string | null, createdAt: any, deletedAt?: any | null, firstName: string, id: string, lastLoginAt?: any | null, lastName: string, roles: Array<UserRoles>, updatedAt: any, username: string, vaultCount: number, assetCount: number, fulfilledObjectCount: number, pendingObjectCount: number, processingObjectCount: number }> } };
